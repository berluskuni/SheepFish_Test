...
class Printer(models.Model):
    ...
    name = models.CharField(max_length=512, null=True, blank=True, verbose_name='Name Printer')
    api_key = models.CharField(max_length=512, verbose_name='Key access API', blank=True, null=True, unique=True)
    check_type = models.CharField(choices=PRINTER_TYPE_CHOICES,
                                  max_length=15, verbose_name='Type check', blank=True, null=True)
...
class Check(models.Model):
    ...
    printer = models.ForeignKey("Printer", blank=True, null=True, related_name='printer', on_delete=models.CASCADE)
    type = models.CharField(choices=PRINTER_TYPE_CHOICES, max_length=512, verbose_name='Type check', blank=True,
                            null=True)
    order = models.JSONField(verbose_name='Information order', null=True, blank=True)
